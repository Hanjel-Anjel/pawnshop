...
if (isset($_POST['submit'])) {
    ...
    // Validate Gmail-only email addresses
    if (!preg_match('/^[a-zA-Z0-9._%+-]+@gmail\.com$/', $email)) {
        $error[] = 'Only Gmail addresses are allowed.';
    } else {
        // Check if the user exists in the customer_users table
...
<head>
    ...
    <title>Customer Login - ArMaTech Pawnshop</title>
    ...
    <div class="login-wrapper">
        ...
        <div class="form-container">
            <form action="" method="post" autocomplete="off">
                <h3><i class="fas fa-user-circle me-2"></i>Customer Login</h3>
                <p class="subtitle">Welcome back to ArMaTech Pawnshop</p>
                ...
                <p class="register-link">
                    Don't have an account? <a href="customer_reg_page.php">Register now</a>
                </p>
            </form>
        </div>
    </div>
